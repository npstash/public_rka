...
// Source File Name:   ChangePasswordContent.java
...
public class ChangePasswordContent implements PacketContent {
	...
	public ChangePasswordContent(String userName, byte authId[]) {
		this.userName = "";
